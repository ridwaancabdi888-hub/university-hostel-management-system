        ...
        'source' => [
            'files' => [
                ...
                'exclude' => [
                    ...
                    base_path('.git'),
                    // Never ship secrets inside a backup archive.
                    base_path('.env'),
                    base_path('.env.production'),
                    // Where backups themselves land (the 'local' disk root) —
                    // excluding this is essential, otherwise every new backup
                    // would recursively bundle every previous one.
