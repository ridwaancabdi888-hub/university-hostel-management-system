...
@switch($name)
    ...
    @case('banknotes')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" {{ $attributes->merge(['class' => 'w-5 h-5']) }}>
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0116.5 0m-16.5 0a60.07 60.07 0 00-1.5-9.75m18 9.75a60.07 60.07 0 00-1.5-9.75m-16.5 0h16.5m-16.5 0v-9a2.25 2.25 0 012.25-2.25h12a2.25 2.25 0 012.25 2.25v9m-16.5 0a2.25 2.25 0 001.5 2.121M18.75 9a2.25 2.25 0 011.5 2.121M12 9.75a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z" />
        </svg>
        @break
