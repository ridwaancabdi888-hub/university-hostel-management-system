<x-dashboard-layout title="Edit Visitor">
    <div class="mb-4">
        <a href="{{ route('visitors.show', $visitor) }}" class="text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">&larr; Back to Visitor</a>
    </div>
        ...
        <form method="POST" action="{{ route('visitors.update', $visitor) }}">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <x-text-input id="relationship" name="relationship" type="text" class="mt-1 block w-full"
                        :value="old('relationship', $visitor->relationship)" />
            ...
            <div class="mt-4">
                ...
                <textarea id="purpose" name="purpose" rows="3" required
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600">{{ old('purpose', $visitor->purpose) }}</textarea>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="expected_at" name="expected_at" type="datetime-local" class="mt-1 block w-full" required
                    :value="old('expected_at', $visitor->expected_at->format('Y-m-d\TH:i'))" />
